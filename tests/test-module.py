...
class Test(unittest.TestCase):  # pylint: disable=too-many-public-methods
    ...
    def test_basic(self):
        ...
        out = open(
            os.path.join(self.test_folder, "basic.output.json"), encoding="utf-8"
        )
    ...
    def test_exception(self):
        ...
        inp = open(
            os.path.join(self.test_folder, "exception.input.json"), encoding="utf-8"
        )
        out = open(
            os.path.join(self.test_folder, "exception.output.json"), encoding="utf-8"
        )
        in_msg = json.loads(inp.read())
        out_msg = json.loads(out.read())
        ...
        with open(data_filename, encoding="utf-8") as file_data:
    ...
    def test_jsonpath(self):
        ...
        inp = open(
            os.path.join(self.test_folder, "jsonpath.input.json"), encoding="utf-8"
        )
        out = open(
            os.path.join(self.test_folder, "jsonpath.output.json"), encoding="utf-8"
        )
        in_msg = json.loads(inp.read())
        out_msg = json.loads(out.read())
    ...
    def test_remote(self):
        ...
        inp = open(
            os.path.join(self.test_folder, "remote.input.json"), encoding="utf-8"
        )
        out = open(
            os.path.join(self.test_folder, "remote.output.json"), encoding="utf-8"
        )
        in_msg = json.loads(inp.read())
        out_msg = json.loads(out.read())
    ...
    def test_configured_remote(self):
        ...
        inp = open(
            os.path.join(self.test_folder, "configured_remote.input.json"),
            encoding="utf-8",
        )
        out = open(
            os.path.join(self.test_folder, "configured_remote.output.json"),
            encoding="utf-8",
        )
        in_msg = json.loads(inp.read())
        out_msg = json.loads(out.read())
    ...
    def test_non_object_configured_remote(self):
        ...
        inp = open(
            os.path.join(self.test_folder, "configured_non_object_remote.input.json"),
            encoding="utf-8",
        )
        out = open(
            os.path.join(self.test_folder, "configured_non_object_remote.output.json"),
            encoding="utf-8",
        )
        in_msg = json.loads(inp.read())
        out_msg = json.loads(out.read())
    ...
    def test_context(self):
        ...
        inp = open(
            os.path.join(self.test_folder, "context.input.json"), encoding="utf-8"
        )
        out = open(
            os.path.join(self.test_folder, "context.output.json"), encoding="utf-8"
        )
        ctx = open(
            os.path.join(self.context_folder, "lambda-context.json"), encoding="utf-8"
        )
        in_msg = json.loads(inp.read())
        out_msg = json.loads(out.read())
    ...
    def test_inline_template(self):
        ...
        inp = open(
            os.path.join(self.test_folder, "inline_template.input.json"),
            encoding="utf-8",
        )
        out = open(
    ...
    def test_templates(self):
        ...
        inp = open(
            os.path.join(self.test_folder, "templates.input.json"), encoding="utf-8"
        )
        out = open(
            os.path.join(self.test_folder, "templates.output.json"), encoding="utf-8"
        )
        in_msg = json.loads(inp.read())
        out_msg = json.loads(out.read())
    ...
    def test_cumulus_context(self):
        ...
        inp = open(
            os.path.join(self.test_folder, "cumulus_context.input.json"),
            encoding="utf-8",
        )
        out = open(
            os.path.join(self.test_folder, "cumulus_context.output.json"),
            encoding="utf-8",
        )
        in_msg = json.loads(inp.read())
        out_msg = json.loads(out.read())
